...
parser = argparse.ArgumentParser(
    ...
    usage="python3 filesystem-name-inspector.py /path/to/directory [optional flags]",  # Custom usage line
    epilog="""
    Examples:
      python3 fs-name-inspector.py /path/to/directory
      python3 fs-name-inspector.py /path/to/directory --csv results.csv
...
if args.directory is None:
    ...
    print(f"{CYAN}Usage: python3 fs-name-inspector.py /path/to/directory [optional flags]{RESET}")
    print(f"{CYAN}For more information, run: python3 fs-name-inspector.py --help{RESET}")
    exit(1)
